...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-04-2019 a las 07:47:35
...
--
CREATE DATABASE IF NOT EXISTS `respaldo` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `respaldo`;
...
CREATE TABLE `caso` (
  ...
  `CodEstatusCaso` int(11) DEFAULT NULL,
  `NumeroCaso` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(8, 10, '2019-04-01 17:49:51', '2019-04-01 22:25:47', NULL, 2, '23456789');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `catestadoequipo`
--

DROP TABLE IF EXISTS `catestadoequipo`;
CREATE TABLE `catestadoequipo` (
  `idEstadoEquipo` int(11) NOT NULL,
  `Descripcion` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `catestadoequipo`
--

INSERT INTO `catestadoequipo` (`idEstadoEquipo`, `Descripcion`) VALUES
(1, 'Funcional'),
(2, 'No Funcional'),
(3, 'Partes');
...
--
-- Estructura de tabla para la tabla `catestatuscaso`
--

DROP TABLE IF EXISTS `catestatuscaso`;
CREATE TABLE `catestatuscaso` (
  `CodEstatusCaso` int(11) NOT NULL,
  `Estatus` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `catestatuscaso`
--

INSERT INTO `catestatuscaso` (`CodEstatusCaso`, `Estatus`) VALUES
(1, 'Abierto'),
(2, 'Cerrado');
...
--
-- Estructura de tabla para la tabla `catpartes`
--

DROP TABLE IF EXISTS `catpartes`;
CREATE TABLE `catpartes` (
  `idPartes` int(11) NOT NULL,
  `DescripcionParte` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `catpartes`
--
...
--
-- Estructura de tabla para la tabla `cattipokit`
--

DROP TABLE IF EXISTS `cattipokit`;
CREATE TABLE `cattipokit` (
  `idTipoKit` int(11) NOT NULL,
  `Descripcion` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `cattipokit`
--

INSERT INTO `cattipokit` (`idTipoKit`, `Descripcion`) VALUES
(4, 'kit de fusor'),
(5, 'kit mantenimiento'),
(6, 'kit ADF');
...
INSERT INTO `cattipousuario` (`codTipoUsuario`, `TipoUsuario`) VALUES
(1, 'Administrador'),
(2, 'usuario General');
...
INSERT INTO `cobertura` (`idCobertura`, `Nombre`) VALUES
(2, 'Ciudad de mexico');
...
CREATE TABLE `comentarios` (
  ...
  `Descrpcion` varchar(2000) DEFAULT NULL,
...
INSERT INTO `comentarios` (`idComentarios`, `Descrpcion`, `idCaso`, `idUsuario`, `FechaInsert`) VALUES
(1, '', 8, 1, NULL),
(2, 'muegano pendejo ....x2', 8, 1, '2019-04-01 23:36:20');
...
CREATE TABLE `contacto` (
  ...
  `Nombre` varchar(200) DEFAULT NULL,
  `Telefoo` varchar(20) DEFAULT NULL,
  `isAES` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `detallecobertura`
--

DROP TABLE IF EXISTS `detallecobertura`;
CREATE TABLE `detallecobertura` (
  `idDetalleCobertura` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `detallecobertura`
--

INSERT INTO `detallecobertura` (`idDetalleCobertura`, `idEstado`, `idMunicipio`, `idCobertura`, `isActive`) VALUES
(4, 1, 1, 2, 0),
(5, 1, 2, 2, 0),
(6, 2, 12, 2, 0),
(7, 9, 266, 2, 0),
...
INSERT INTO `documentos` (`idDocumentos`, `Descripcion`, `idEquipo`, `idTipoDocumento`, `idCaso`, `FechaInsert`, `Comentario`) VALUES
(2, '99D08DBB-C47C-0BDD-F579-C5A0472055B6.jpg', 1, 1, NULL, NULL, NULL),
(3, '11E4AB69-0EC9-8CA6-79A1-F9F2CFBF25FD.pdf', 2, 1, NULL, NULL, NULL),
(4, '65EC5EDD-1E22-01B8-10FA-6AD34AC53EE9.jpg', 4, 1, NULL, NULL, NULL),
(5, '1D9D2BB0-BCF5-CCC4-5E56-D7E785F957C3.jpg', 4, 1, NULL, NULL, NULL),
(6, '0C340E7D-0BB8-C9CB-A9AC-188874035C20.jpg', 4, 1, NULL, NULL, NULL),
(7, '4F9FCE97-5B7D-38D1-BF8B-D6DFEC91A5B0.jpg', 3, 1, NULL, NULL, NULL),
(8, 'C4D90565-330C-8795-6D65-380DDA4465CD.jpg', 3, 1, NULL, NULL, NULL),
(9, '5B3AB0D7-9A78-E3FC-322F-6A8269175839.jpg', 3, 1, NULL, NULL, NULL),
(10, 'C2C2CBE5-FE56-F9AE-0D75-A53553DD8EC7.jpg', 3, 1, NULL, NULL, NULL),
...
CREATE TABLE `equipo` (
  ...
  `IsDisponible` int(11) DEFAULT NULL,
  `idModelo` int(11) DEFAULT NULL,
  `idCuenta` int(11) DEFAULT NULL,
  `idEstadoEquipo` int(11) DEFAULT NULL,
  `idAES` int(11) DEFAULT NULL,
  `idEstado` int(11) DEFAULT NULL,
  `idMunicipio` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `equipoparte`
--

DROP TABLE IF EXISTS `equipoparte`;
CREATE TABLE `equipoparte` (
  `idEquipoParte` int(11) NOT NULL,
  `idEquipo` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `equipoparte`
--
...
--
-- Estructura de tabla para la tabla `estados_muni`
--

DROP TABLE IF EXISTS `estados_muni`;
CREATE TABLE `estados_muni` (
  `id_estados_muni` int(100) NOT NULL,
  `idEstado` int(100) DEFAULT NULL,
  `idMunicipio` int(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `estados_muni`
--

INSERT INTO `estados_muni` (`id_estados_muni`, `idEstado`, `idMunicipio`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
CREATE TABLE `kit` (
  ...
  `DetalleKIT` varchar(200) DEFAULT NULL,
  `idTipoKit` int(11) DEFAULT NULL,
  `idEquipo` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indices de la tabla `catestadoequipo`
--
ALTER TABLE `catestadoequipo`
  ADD PRIMARY KEY (`idEstadoEquipo`);

--
-- Indices de la tabla `catestatuscaso`
--
ALTER TABLE `catestatuscaso`
  ADD PRIMARY KEY (`CodEstatusCaso`);

--
-- Indices de la tabla `catpartes`
--
ALTER TABLE `catpartes`
  ADD PRIMARY KEY (`idPartes`);

--
-- Indices de la tabla `cattipokit`
--
ALTER TABLE `cattipokit`
  ADD PRIMARY KEY (`idTipoKit`);
...
--
-- Indices de la tabla `detallecobertura`
--
ALTER TABLE `detallecobertura`
  ADD PRIMARY KEY (`idDetalleCobertura`);
...
--
-- Indices de la tabla `equipoparte`
--
ALTER TABLE `equipoparte`
  ADD PRIMARY KEY (`idEquipoParte`);
...
--
-- Indices de la tabla `estados_muni`
--
ALTER TABLE `estados_muni`
  ADD PRIMARY KEY (`id_estados_muni`);
...
--
ALTER TABLE `catestadoequipo`
  MODIFY `idEstadoEquipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `catestatuscaso`
--
ALTER TABLE `catestatuscaso`
  MODIFY `CodEstatusCaso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `cattipokit`
  MODIFY `idTipoKit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `cobertura`
  MODIFY `idCobertura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `comentarios`
--
ALTER TABLE `comentarios`
  MODIFY `idComentarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `detallecobertura`
  MODIFY `idDetalleCobertura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `estados`
  MODIFY `idEstado` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT de la tabla `estados_muni`
--
ALTER TABLE `estados_muni`
  MODIFY `id_estados_muni` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2458;
...
--
ALTER TABLE `municipios`
  MODIFY `idMunicipio` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2096;
