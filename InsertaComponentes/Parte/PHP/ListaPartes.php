...
if($rowcount != 0){
  ...
  <td style="font-size: 13px">'.$userRow1["DescripcionParte"].'</td>
  <td style="font-size: 13px"><i onclick=\'Parte_DeleteParte('.$userRow1["idPartes"].')\' class="fa fa-trash-alt" style="cursor:pointer;"></i></td>
  </tr>';
//$userRow1["idtipokit"]
  $count++;
  }
