...
ConfiguracionEquipo_GetCartaResponsiva();
  function ConfiguracionEquipo_GetCartaResponsiva(){
      ...
      function(response){
        if(response != 0){
          $('#ConfiguracionEquipo_CartaResponsivaDIV').html("<div class='col-md-12 text-center'><i onclick=\"window.open('" + response + "');\" class='fa fa-file' style='font-size: 40px;cursor: pointer;'></i></div>");
        }
      });
  }
